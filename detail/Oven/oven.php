        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 d-flex flex-column align-items-center mb-4 mb-lg-0 position-relative">
                <div class="w-full h-45 product-image-container" >
                    <img id="mainProductImage" src="../../pic/7080_1.png" alt="Main Product Image">
                ...
                <div class="d-flex flex-row flex-lg-column justify-content-center w-100 overflow-auto space-x-2 space-y-lg-2">
                    <div class="product-image-container flex-shrink-0 cursor-pointer" style="width: 80px; height: 80px; margin-left: 2rem;" onclick="setMainImage(0)">
                        ...
                        <img src="../../pic/7080_1.png" alt="Thumbnail 1">
                    </div>
                    <div class="product-image-container flex-shrink-0 cursor-pointer" style="width: 80px; height: 80px;  margin-left: 2rem;" onclick="setMainImage(1)">
                        <img src="../../pic/7080_2.png" alt="Thumbnail 2">
                    </div>
            ...
            <div class="col-12 col-lg-6">
               <img src="../img/logo.svg" alt="" style="width:20%;">
                <h1 class="display-6 fw-bold text-dark mb-2 magin_left">Built_In Oven</h1>
                ...
                <div class="mb-3 magin_left">
                    <label for="animal" class="form-label fw-semibold mb-1 font_color2">MODEL : RC.7080L</label>
                  <p class="fw-semibold mb-2">Dimensions</p>
                    <ul class="list-unstyled">
                        <li><strong>PRODUCT DIMENSIONS : </strong>( D x W x H ) 595 x 595 x 585 mm</li>
                        <li><strong>CUT-OUT DIMENSIONS : </strong>( D x W x H ) 560 x 606 x 590 mm</li>
                    </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <p class="fw-semibold mb-2">Products details:</p>
                     <ul class="list-unstyled">
                        <li><i class="fas fa-check-circle text-success me-2"></i>Material : Stainless Steel Black Glass</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Oven Capacity : 70L</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Fully Glass Door</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>9 Cooking Funtions Convenction Fan Incluled</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Touch And Knob Control With LED Display</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Enamel Oven Cavity Easy to Clean</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Alarm Function</li>
                </div>
                <div class="col-lg-6">
                    <ul class="list-unstyled">
                        <li><i class="fas fa-check-circle text-success me-2"></i>Electronic Child Lock</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>3-Layer Glass</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>A Energy Class</li>
