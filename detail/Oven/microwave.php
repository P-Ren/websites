        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 d-flex flex-column align-items-center mb-4 mb-lg-0 position-relative">
                <div class="w-full h-45 product-image-container" >
                    <img id="mainProductImage" src="../../pic/2505_1.png" alt="Main Product Image">
                ...
                <div class="d-flex flex-row flex-lg-column justify-content-center w-100 overflow-auto space-x-2 space-y-lg-2">
                    <div class="product-image-container flex-shrink-0 cursor-pointer" style="width: 80px; height: 80px; margin-left: 2rem;" onclick="setMainImage(0)">
                        ...
                        <img src="../../pic/2505_1.png" alt="Thumbnail 1">
                    </div>
                    <div class="product-image-container flex-shrink-0 cursor-pointer" style="width: 80px; height: 80px;  margin-left: 2rem;" onclick="setMainImage(1)">
                        <img src="../../pic/2505_2.png" alt="Thumbnail 2">
                    </div>
                    <!-- <div class="product-image-container flex-shrink-0 cursor-pointer" style="width: 80px; height: 80px;  margin-left: 2rem;" onclick="setMainImage(2)">
                        <img src="../../pic/822_3.png" alt="Thumbnail 3">
                    </div> -->
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6">
               <img src="../img/logo.svg" alt="" style="width:20%;">
                <h1 class="display-6 fw-bold text-dark mb-2 magin_left">Built_In Microwave</h1>
                ...
                <div class="mb-3 magin_left">
                    <label for="animal" class="form-label fw-semibold mb-1 font_color2">MODEL : RC.2505L</label>
                  <p class="fw-semibold mb-2">Dimensions</p>
                    <ul class="list-unstyled">
                        <li><strong>PRODUCT DIMENSIONS : </strong>( D x W x H ) 595 x 400 x 370 mm</li>
                        <li><strong>CUT-OUT DIMENSIONS : </strong>( D x W x H ) 560 x 400 x 380 mm</li>
                    </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <p class="fw-semibold mb-2">Products details:</p>
                     <ul class="list-unstyled">
                        <li><i class="fas fa-check-circle text-success me-2"></i>Buit-in Microwave With Girll</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Oven Capacity : 25L</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>8 Cooking Funtions</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>9 Cooking Funtions Convenction Fan Incluled</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Degital Control With LED Display</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Cavity Material Stainless Steel</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Turntable Diameter : 315mmn</li>
                </div>
                <div class="col-lg-6">
                    <ul class="list-unstyled">
                        <li><i class="fas fa-check-circle text-success me-2"></i>Child Safety Lock</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Microwave Power : 1000W</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Girll Power : 1000W</li>
