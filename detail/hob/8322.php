        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 d-flex flex-column align-items-center mb-4 mb-lg-0 position-relative">
                <div class="w-full h-45 product-image-container" >
                    <img id="mainProductImage" src="../../pic/8322_1.png" alt="Main Product Image">
                ...
                <div class="d-flex flex-row flex-lg-column justify-content-center w-100 overflow-auto space-x-2 space-y-lg-2">
                    <div class="product-image-container flex-shrink-0 cursor-pointer" style="width: 80px; height: 80px; margin-left: 2rem;" onclick="setMainImage(0)">
                        ...
                        <img src="../../pic/8322_1.png" alt="Thumbnail 1">
                    </div>
                    <div class="product-image-container flex-shrink-0 cursor-pointer" style="width: 80px; height: 80px;  margin-left: 2rem;" onclick="setMainImage(1)">
                        <img src="../../pic/8322_2.png" alt="Thumbnail 2">
                    </div>
            ...
            <div class="col-12 col-lg-6">
               <img src="../img/logo.svg" alt="" style="width:20%;">
                ...
                <div class="mb-3 magin_left">
                    <label for="animal" class="form-label fw-semibold mb-1 font_color2">MODEL : RC.8322G</label>
                  <p class="fw-semibold mb-2">Dimensions</p>
                    <ul class="list-unstyled">
                        <li><strong>PRODUCT DIMENSIONS : </strong>( W x D ) 750 x 450 mm</li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <p class="fw-semibold mb-2">Products details:</p>
                     <ul class="list-unstyled">
                        <li><i class="fas fa-check-circle text-success me-2"></i>3 Cooking Zones</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Sensor Touch  Control</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Glass Full Sapphire Coating</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Booster Fuction  Saving 35% Of Power Consumption</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Timer Cooking Fuction</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Over Heat Protection</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>9 Stages Power Setting</li>
                </div>
                <div class="col-lg-6">
                    <ul class="list-unstyled">
                        <li><i class="fas fa-check-circle text-success me-2"></i>Timer 1 - 99 Minutes</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Child Safety Lock Fuction</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Residual Heating Weaning “ H ”</li>
                        <li><i class="fas fa-check-circle text-success me-2"></i>Total Power : 6400W</li>
